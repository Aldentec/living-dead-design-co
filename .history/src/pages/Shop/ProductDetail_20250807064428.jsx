                ...
                <div className="d-flex flex-wrap gap-2">
                    ...
                    return (
                        <Button
                            ...
                            className="d-flex flex-column align-items-start variant-button text-start p-2"
                            style={{
                                minWidth: '180px',
                                color: selectedVariant === variant ? '#fff' : '#f8f9fa',
                                backgroundColor: selectedVariant === variant ? '' : '#6c757d33'
                            }}
                            >
                        </Button>
                    );
