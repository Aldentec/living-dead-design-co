...
export default function Custom() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setToastMessage('Custom order request submitted successfully! We\'ll be in touch soon.');
      setShowToast(true);
      ...
      setToastMessage('Something went wrong. Please try again or contact us directly.');
      setShowToast(true);
    } finally {
